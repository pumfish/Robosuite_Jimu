...
class Jimu(SingleArmEnv):
    ...
    def staged_rewards(self):
        ...
        #    r_stack = 2.0
        cubeA_in_right_pos = ((cubeA_pos[0] >= cubeB_pos_ranges[0][0]).all() and (cubeA_pos[0] <= cubeB_pos_ranges[0][1]).all()) and \
                             ((cubeA_pos[1] >= cubeB_pos_ranges[1][0]).all() and (cubeA_pos[1] <= cubeB_pos_ranges[1][1]).all()) and \
                             ((cubeA_pos[2] >= cubeB_pos_ranges[2][0]).all() and (cubeA_pos[2] <= cubeB_pos_ranges[2][1]).all())
