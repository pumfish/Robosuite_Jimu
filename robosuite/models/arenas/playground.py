...
class PlayArena(Arena):
    ...
    def __init__(
        ...
        if layout == "ssss":
            super().__init__(xml_path_completion("arenas/playground_arena.xml"))
        elif layout == "bbbb":
            super().__init__(xml_path_completion("arenas/playground_arena_bbbb.xml"))
        elif layout == "bbss":
            super().__init__(xml_path_completion("arenas/playground_arena_bsbs.xml"))
